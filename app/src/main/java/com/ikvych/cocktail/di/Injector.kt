        ...
        override fun <T : ViewModel?> create(
            ...
            return when(modelClass) {
                ...
                MainFragmentViewModel::class.java -> MainFragmentViewModel(provideRepository(appContext), provideModelMapper(
                    appContext),application, handle) as T
                DrinkViewModel::class.java -> DrinkViewModel(application, handle, provideRepository(appContext), provideModelMapper(
                    appContext)) as T
                BaseViewModel::class.java -> BaseViewModel(application, handle) as T
