...
import com.ikvych.cocktail.cocktail.MainFragment
import com.ikvych.cocktail.main.databinding.ActivityMainBinding
import com.ikvych.cocktail.main.listener.MainActivityLifecycleObserver
import com.ikvych.cocktail.prresentation.dialog.bottom.ResumeAppBottomSheetDialogFragment
...
import com.ikvych.cocktail.prresentation.util.enumeration.ShortcutType
import com.ikvych.cocktail.setting.SettingFragment
...
/*    override fun onResume() {
    ...
    override fun configureView(savedInstanceState: Bundle?) {
        ...
        bnv_main.setOnNavigationItemSelectedListener { item ->
            when (item.itemId) {
                com.ikvych.cocktail.prresentation.R.id.menu_main_fragment -> {
...
/*                    viewModel.firebase.logEvent(FirebaseAnalytics.Event.SELECT_ITEM, bundleOf(
                ...
                com.ikvych.cocktail.prresentation.R.id.menu_profile_fragment -> {
                    val ft: FragmentTransaction = supportFragmentManager.beginTransaction()
...
/*                    val intent = Intent(this, DrinkDetailActivity::class.java)
                    ...
                    detailStarter.startDetailById(COCKTAIL_ID, cocktailId)
                }
                com.ikvych.cocktail.prresentation.R.id.ib_popup_menu -> {
            ...
            PopupMenu(this, v).apply {
                ...
                setOnMenuItemClickListener {
                    when (it.itemId) {
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_open -> {
/*                            val intent =
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_add_favorite -> {
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_remove_favorite -> {
                            viewModel.saveFavoriteDrink(cocktail)
                            Toast.makeText(
                                this@MainActivity,
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_remove -> {
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_pin_shortcut -> {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                val shortcutManager =
                                    ContextCompat.getSystemService(
                                        this@MainActivity,
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_add_dynamic_shortcut -> {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                val shortcutManager =
                                    ContextCompat.getSystemService(
                                        this@MainActivity,
                        ...
                        com.ikvych.cocktail.prresentation.R.id.menu_drink_remove_dynamic_shortcut -> {
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
                                val shortcutManager =
                                    ContextCompat.getSystemService(
                                        this@MainActivity,
    ...
    private fun configurePopupMenu(menu: PopupMenu, cocktail: CocktailModel) {
        menu.menu.add(0, com.ikvych.cocktail.prresentation.R.id.menu_drink_open, 0, getString(R.string.open))
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            if (shortcutAlreadyExist(cocktail.id, ShortcutType.PINNED_SHORTCUT)) {
                menu.menu.removeItem(com.ikvych.cocktail.prresentation.R.id.menu_drink_pin_shortcut)
            } else {
                menu.menu.add(0, com.ikvych.cocktail.prresentation.R.id.menu_drink_pin_shortcut, 0, getString(R.string.pin_shortcut))
            }
            if (shortcutAlreadyExist(cocktail.id, ShortcutType.DYNAMIC_SHORTCUT)) {
                menu.menu.removeItem(com.ikvych.cocktail.prresentation.R.id.menu_drink_add_dynamic_shortcut)
                menu.menu.add(
                    0,
                    com.ikvych.cocktail.prresentation.R.id.menu_drink_remove_dynamic_shortcut,
                    0,
                ...
                menu.menu.removeItem(com.ikvych.cocktail.prresentation.R.id.menu_drink_remove_dynamic_shortcut)
                menu.menu.add(
                    0,
                    com.ikvych.cocktail.prresentation.R.id.menu_drink_add_dynamic_shortcut,
                    0,
        ...
        if (cocktail.isFavorite) {
            menu.menu.removeItem(com.ikvych.cocktail.prresentation.R.id.menu_drink_add_favorite)
            menu.menu.add(
                0,
                com.ikvych.cocktail.prresentation.R.id.menu_drink_remove_favorite,
                0,
            ...
            menu.menu.removeItem(com.ikvych.cocktail.prresentation.R.id.menu_drink_remove_favorite)
            menu.menu.add(0, com.ikvych.cocktail.prresentation.R.id.menu_drink_add_favorite, 0, getString(R.string.add_favorite))
        }
        menu.menu.add(0, com.ikvych.cocktail.prresentation.R.id.menu_drink_remove, 0, getString(R.string.remove))
    }

    @RequiresApi(Build.VERSION_CODES.O)
    private fun createDrinkShortcut(view: View, cocktail: CocktailModel, type: ShortcutType): ShortcutInfo {
        val drinkImageView = view.findViewById(com.ikvych.cocktail.prresentation.R.id.iv_drink_image) as ImageView
...
/*                        val intent = Intent(this, DrinkDetailActivity::class.java)
                        ...
                        startActivity(intent)*/
                        detailStarter.startDetailById(COCKTAIL_ID, data as Long)
                    }
                    LeftDialogButton -> {
                        dialog.dismiss()
                    }
