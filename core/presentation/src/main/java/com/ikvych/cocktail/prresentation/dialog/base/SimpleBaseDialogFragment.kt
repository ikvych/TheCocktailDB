package com.ikvych.cocktail.prresentation.dialog.base
...
import kotlinx.android.synthetic.main.layout_bottom_sheet_dialog_simple.*
...
protected constructor() : BaseDialogFragment<Data, ButtonType, Type>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        view.findViewById<TextView>(R.id.tv_dialog_title).text = dialogBuilder.titleText.takeIf { it.isNotEmpty() }
