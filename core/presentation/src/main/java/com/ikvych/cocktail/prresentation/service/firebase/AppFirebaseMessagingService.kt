package com.ikvych.cocktail.prresentation.service.firebase
...
/*    private val pushGson: Gson
        get() = GsonBuilder()
            .registerTypeAdapter(
                deserializeType<com.ikvych.cocktail.firebase.firebase.model.NotificationModel>(),
    ...
    override fun onMessageReceived(p0: RemoteMessage) {
        ...
        if (p0.data.isNotEmpty()) {
            ...
            val notificationModel = pushGson.fromJson(
                ...
                com.ikvych.cocktail.firebase.firebase.model.NotificationModel::class.java
            )
    ...
    private fun configureNotification(model: com.ikvych.cocktail.firebase.firebase.model.NotificationModel) {
        ...
        if (model.type == com.ikvych.cocktail.firebase.firebase.model.NotificationType.NOTIFICATION_TYPE_COCKTAIL_DETAIL) {
    ...
    private fun createCustomNotification(
        ...
        model: com.ikvych.cocktail.firebase.firebase.model.NotificationModel
    ) {
        // сервіс для додавання коктейлю в улюблені
        val serviceIntent = Intent(this, com.ikvych.cocktail.firebase.firebase.NotificationActionService::class.java).apply {
